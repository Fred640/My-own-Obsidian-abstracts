Props - аргументы, араметры которые компонент может принимать из вне, но обмен всегда происходит от родителя к дочернему компоненту. Обратный процуесс можно реализовать с помощью функции обратного вызова 
